...
mixin _$ScreenState<T> {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ScreenState<T>);
  }
...
/// @nodoc
class $ScreenStateCopyWith<T, $Res> {
  $ScreenStateCopyWith(ScreenState<T> _, $Res Function(ScreenState<T>) __);
}

/// @nodoc

class _Initial<T> implements ScreenState<T> {
  const _Initial();
  ...
  @override
  String toString() {
    return 'ScreenState<$T>.initial()';
  }
}

/// @nodoc

class Loading<T> implements ScreenState<T> {
  const Loading();
...
class Success<T> implements ScreenState<T> {
  ...
  @override
  String toString() {
    return 'ScreenState<$T>.success(data: $data)';
  }
}
...
class Error<T> implements ScreenState<T> {
  ...
  @override
  String toString() {
    return 'ScreenState<$T>.error(error: $error)';
  }
}
