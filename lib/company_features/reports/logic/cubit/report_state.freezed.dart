...
/// @nodoc
mixin _$ReportState<T> {
  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ReportState<T>);
  }
...
/// @nodoc
class $ReportStateCopyWith<T, $Res> {
  $ReportStateCopyWith(ReportState<T> _, $Res Function(ReportState<T>) __);
}

/// @nodoc

class _Initial<T> implements ReportState<T> {
  const _Initial();
  ...
  @override
  String toString() {
    return 'ReportState<$T>.initial()';
  }
}

/// @nodoc

class Loading<T> implements ReportState<T> {
  const Loading();
  ...
  @override
  String toString() {
    return 'ReportState<$T>.loading()';
  }
}

/// @nodoc

class Success<T> implements ReportState<T> {
  ...
  @override
  String toString() {
    return 'ReportState<$T>.success(data: $data)';
  }
}

/// @nodoc
abstract mixin class $SuccessCopyWith<T, $Res>
    implements $ReportStateCopyWith<T, $Res> {
...
class Error<T> implements ReportState<T> {
  ...
  @override
  String toString() {
    return 'ReportState<$T>.error(error: $error)';
  }
}
