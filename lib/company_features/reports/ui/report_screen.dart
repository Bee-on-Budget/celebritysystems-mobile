...
class _ReportScreenState extends State<ReportScreen> {
  ...
  void _getAnalytics() {
    ...
    Future.delayed(Duration(seconds: 2), () async {
      final AnalyticsResponse? analyticsData =
          await _reportCubit.getAnalytics(request);
  ...
  void _showAnalyticsDialog(AnalyticsResponse? analyticsData) {
    showDialog(
      context: context,
      builder: (context) => analyticsData == null
          ? SizedBox()
          : AlertDialog(
              shape: RoundedRectangleBorder(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              ColorsManager.paleLavenderBlue.withOpacity(0.1),
                          borderRadius: BorderRadius.circular(12.r),
                          border: Border.all(
                            color:
                                ColorsManager.paleLavenderBlue.withOpacity(0.3),
                            width: 1,
                          ),
                        ),
                        child: Column(
                                    ...
                                    child: Row(
                                      children: [
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            color:
                                                _getServiceTypeColor(entry.key),
                                            shape: BoxShape.circle,
                                          ),
                                        ),
                                        SizedBox(width: 12.w),
                      ...
                      if (analyticsData
                          .averageTimeByServiceType.isNotEmpty) ...[
                        SizedBox(height: 16.h),
                        Container(
                          width: double.infinity,
                          padding: EdgeInsets.all(16.w),
